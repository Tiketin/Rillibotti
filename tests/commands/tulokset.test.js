...
const { default: tuloksetCommand } = await import('../../commands/tulokset.js');
...
describe('Tulokset Command', () => {
    ...
    test('should show error message if no driver standings found', async () => {
        ...
        await tuloksetCommand.execute(mockInteraction);
    ...
    test('should format driver standings correctly', async () => {
        ...
        expect(mockInteraction.followUp).toHaveBeenCalledWith(
            expect.objectContaining({
                content: expect.stringContaining('Max Verstappen')
            })
        );
    });
